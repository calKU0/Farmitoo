...
namespace PobieranieIWysylka
{
    public partial class Form1 : Form
    {
        ...
        string sftpFolderPath = ConfigurationManager.AppSettings["SftpOrderFolderPath"];
        string localPath = ConfigurationManager.AppSettings["LocalOrderPath"];
        string sftpArchFolderPath = ConfigurationManager.AppSettings["sftpArchFolderPath"];
